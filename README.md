# 🧬 Лабораторная № 2 · Раскраска графа · ограничения и операторы
...
![Результат лабораторной работы](results/coloring.png)
...
python main.py --runs 1 --seed 27000 --output results_custom/smoke
...
git init
git add .
git commit -m "Add lab 2: variant 16, group 507"
```
